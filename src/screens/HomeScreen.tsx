      ...
      <SafeAreaView style={{paddingVertical: 24, gap: 24}}>
        ...
        <MasonryList
          ...
          renderItem={({item, i}) => (
            ...
            >
              <Image source={require('../assets/omg.png')} 
              resizeMode='cover'
...
const Cards = () => {
  return (
    <View style={{flex: 1, position: "relative", overflow: 'hidden', borderRadius: 24}}>
      ...
      <View style={{ position: 'absolute', left: 16, top: 16, gap: 40}}>
        <View style={{  flexDirection: 'row', marginBottom: 48}}>
          <Text style={{ fontSize: 16, fontWeight: '600', marginRight: 36}}>No 5 Chanel</Text>
          <View style={{ backgroundColor: "#fff", borderRadius: 100, height: 32, aspectRatio: 1, alignItems: "center", justifyContent: 'center'}}>
            <Icons name='favorite-border' size={20} color="#191919"/>
          </View>
        </View>
        <View style={{ flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 24, borderRadius: 100, overflow: 'hidden'}}>
